...
fun ColorSpinnerRow(
    ...
    InputRow(inputLabel = stringResource(id = com.example.juicetracker.R.string.color), modifier = modifier) {
        ...
        factory = {
            Spinner(it).apply {
                ...
                spinner.onItemSelectedListener = SpinnerAdapter(onColorChange = onColorChange)
            })
    }
}
